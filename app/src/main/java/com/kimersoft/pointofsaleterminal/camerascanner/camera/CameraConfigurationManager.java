...
package com.kimersoft.pointofsaleterminal.camerascanner.camera;
...
final class CameraConfigurationManager {
   ...
   * 横屏
   */
  void initFromCameraParametersH(Camera camera) {
  ...
  void setDesiredCameraParameters(Camera camera) {
    ...
    if(direct==1||direct==3) camera.setDisplayOrientation(90); 
