...
/**
 * Created by Workstation on 20/02/2018.
 */

public class CardLynqPSAM2 extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.button_power_on:
                openCard();
                break;
            case R.id.button_power_off:
                closeCard();
                break;
