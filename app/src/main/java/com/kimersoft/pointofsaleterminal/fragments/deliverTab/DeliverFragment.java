package com.kimersoft.pointofsaleterminal.fragments.deliverTab;
...
public class DeliverFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvDeliver =view.findViewById(R.id.rv_waiting);
        rvDeliver.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.HORIZONTAL, false));
    //    WaitingAdapter waitingAdapter=new WaitingAdapter(getActivity(),new ArrayList<String >(), ItemSelector.DELIVER_ITEM);
     //   rvDeliver.setAdapter(waitingAdapter);
        return view;
